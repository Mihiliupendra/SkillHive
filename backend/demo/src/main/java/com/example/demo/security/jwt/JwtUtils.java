...
public class JwtUtils {
    ...
    public ResponseCookie generateJwtCookie(String userId, String username) {
        String jwt = generateTokenFromUsername(userId, username);
    ...
    public String generateTokenFromUsername(String userId, String username) {
        return Jwts.builder()
                .setSubject(username)
                .claim("userId", userId)
